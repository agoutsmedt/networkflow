                          ...
                          order_column = "minimize_crossing_order")
{
  ...
  window_column_plot <- ensym(window_column)
  y_alluv_column_plot <- ensym(y_alluv_column)
  stratum_column_plot <- ensym(stratum_column)
  alluvium_column_plot <- ensym(alluvium_column)
  ...
  alluv_plot < - ggplot(alluv_plot, aes(x = !!window_column_plot, y = !!y_alluv_column_plot, stratum = !!stratum_column_plot, alluvium = !!alluvium_column_plot, fill = color, label = !!stratum_column_plot)) +
    ...
    scale_fill_identity() +
    ggtitle("") +
    ggrepel::geom_label_repel(stat = "stratum", aes(label = !!label_column_plot))
